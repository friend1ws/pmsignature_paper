...
getF <- function(type, K, index, trDir = TRUE) {
  ...
  if (trDir ==  TRUE) {
    inputName <- paste("../../analysis/AlexandrovEtAl/result/Param_ind5_dir/", type, ".", as.character(K), ".Rdata", sep="");
  } else {
    inputName <- paste("../../analysis/AlexandrovEtAl/result/Param_ind5/", type, ".", as.character(K), ".Rdata", sep="");
  }
