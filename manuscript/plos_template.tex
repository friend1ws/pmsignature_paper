...
\subfigure[APOBEC signature list]{%
  \includegraphics[width=16cm,height=7.5cm]{signatureList_APOBEC.eps}
...
\subfigure[POLE1 signature list]{%
  \includegraphics[width=8cm,height=2.5cm]{signatureList_POLE1.eps}
  \label{POLE1_sig_list}}
  
\subfigure[POLE2 signature list]{%
  \includegraphics[width=8cm,height=2.5cm]{signatureList_POLE2.eps}
  \label{POLE2_sig_list}}
  
\subfigure[UV signature list]{%
  \includegraphics[width=8cm,height=2.5cm]{signatureList_UV.eps}
  \label{UV_sig_list}}

\subfigure[LMST signature list]{%
  \includegraphics[width=8cm,height=2.5cm]{signatureList_LMST.eps}
  \label{LMST_sig_list}}
