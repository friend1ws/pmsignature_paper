...
do
    ...
    do
        ...
        if [ ${type} == Lung-Adeno ]
        then 
            echo "qsub -l s_vmem=4G,mem_req=4 -e ${SCRIPTDIR}/log -o ${SCRIPTDIR}/log perform_pmsignature.sh ${RESULTDIR}/MPFormat/${type}.mp.txt.gz ${RESULTDIR}/Param_ind5_dir/${type}.${K}.Rdata ${K} TRUE 10"
            qsub -l s_vmem=4G,mem_req=4 -e ${SCRIPTDIR}/log -o ${SCRIPTDIR}/log perform_pmsignature.sh ${RESULTDIR}/MPFormat/${type}.mp.txt.gz ${RESULTDIR}/Param_ind5_dir/${type}.${K}.Rdata ${K} TRUE 10
        else
            echo "qsub -l s_vmem=2G,mem_req=2 -e ${SCRIPTDIR}/log -o ${SCRIPTDIR}/log perform_pmsignature.sh ${RESULTDIR}/MPFormat/${type}.mp.txt.gz ${RESULTDIR}/Param_ind5_dir/${type}.${K}.Rdata ${K} TRUE 10"
            qsub -l s_vmem=2G,mem_req=2 -e ${SCRIPTDIR}/log -o ${SCRIPTDIR}/log perform_pmsignature.sh ${RESULTDIR}/MPFormat/${type}.mp.txt.gz ${RESULTDIR}/Param_ind5_dir/${type}.${K}.Rdata ${K} TRUE 10
        fi
