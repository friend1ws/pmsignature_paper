...
mutation signature & the $j$-th mutation  & the feature dist.  & the signature dist.  \\
model & in the $i$-th cancer genome & for the $k$-th signature & for the $i$-th cancer genome \\ \hline
...
population structure  & the $j$-th locus genotype & the allele freq.  & the admixture dist. \\
model & of the individual $i$  & for the ancestry $k$ & for the individual $i$ \\
\hline 
\end{tabular}
\label{tab_pop}
% \end{adjustwidth}
