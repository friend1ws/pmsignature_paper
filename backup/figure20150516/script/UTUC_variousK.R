...
PMSSigPlot(2);
outputName <- "../../supp/UTUC_signature_K2.eps";
dev.copy2eps(file=outputName, height = 6, width = 15, pointsize = 9);
par(.pardefault);
dev.off();

PMSSigPlot(3);
outputName <- "../../supp/UTUC_signature_K3.eps";
dev.copy2eps(file=outputName, height = 6, width = 15, pointsize = 9);
par(.pardefault);
dev.off();

PMSSigPlot(4);
outputName <- "../../supp/UTUC_signature_K4.eps";
dev.copy2eps(file=outputName, height = 6, width = 15, pointsize = 9);
par(.pardefault);
dev.off();
...
ggsave("../../supp/UTUC_AA_AAlike_cor.eps", width=8, height=8);
